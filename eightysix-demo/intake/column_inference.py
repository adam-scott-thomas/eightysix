...
_GLOBAL_SYNONYMS: dict[str, str] = {
    # Dates
    "date": "date", "business date": "date", "business_date": "date",
    "period": "date", "week": "date", "report date": "date", "week of": "date",
    # Location
...
_TYPE_SYNONYMS: dict[ReportType, dict[str, str]] = {
    ReportType.SALES_SUMMARY: {
        ...
        "gross revenue": "gross_sales", "gross": "gross_sales", "total revenue": "gross_sales",
        ...
        "dine in sales": "net_sales", "dine-in sales": "net_sales",
        "takeout sales": "net_sales", "catering sales": "net_sales",
        "discounts": "discounts", "discount": "discounts",
        "avg check": "avg_check", "average check": "avg_check",
        "tax collected": "tax", "tax": "tax",
    ...
    ReportType.PUNCHES: {
        ...
        "employee name": "employee_id", "employee id": "employee_id",
        "role": "role", "position": "role", "job": "role", "job title": "role",
        "hours": "hours", "total hours": "hours", "duration": "hours",
        "actual hrs": "hours", "actual hours": "hours",
        "scheduled hrs": "scheduled_hours", "scheduled hours": "scheduled_hours",
        "overtime hrs": "overtime_hours", "ot hrs": "overtime_hours",
        "hourly rate": "hourly_rate", "rate": "hourly_rate",
        "total pay": "total_pay", "regular pay": "regular_pay",
    },
    ReportType.SCHEDULE: {
    ...
    ReportType.REFUNDS_VOIDS_COMPS: {
        "refund amount": "amount", "refund amt": "amount",
        "refund $": "amount", "void amount": "amount",
        "comp amount": "amount",
        "adjustment": "amount", "amount": "amount", "amount $": "amount",
        "employee": "employee_id", "emp": "employee_id", "team member": "employee_id",
        "staff": "employee_id", "server": "employee_id", "cashier": "employee_id",
        "type": "refund_type", "action": "refund_type", "action type": "refund_type",
        "comp or void": "refund_type", "void or comp": "refund_type",
        ...
        "table/order #": "order_id", "table order #": "order_id",
        "refund #": "refund_id", "refund id": "refund_id",
        "manager": "manager", "approved by": "manager", "mgr": "manager",
        "manager approved": "manager",
        "item(s)": "item_name", "items": "item_name", "item": "item_name",
